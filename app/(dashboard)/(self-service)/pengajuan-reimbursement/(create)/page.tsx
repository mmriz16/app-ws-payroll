...
function ReimbursementTable({ rows }: { rows: ReimbursementRow[] }) {
    return (
        <div className="border border-black/10 overflow-x-auto">
            <table className="min-w-[600px] w-full divide-y divide-black/10 text-left text-xs">
    ...
    return (
        <div className="flex flex-1 flex-col text-black">
            <section className="flex flex-1 flex-col gap-4 md:gap-6 p-3 sm:p-4 md:p-6">
                <Link href="/pengajuan-reimbursement" className="flex w-full sm:w-fit items-center justify-center text-xs sm:text-sm font-semibold text-black">
                    <ArrowLeft className="w-4 h-4 mr-2" />
                    Kembali
                </Link>
                <div className="flex flex-wrap items-center gap-1.5 text-xs sm:text-sm text-black/60">
                    <span>Home</span>
                    <span>/</span>
                ...
                <div className="flex flex-col gap-4 border border-black/10 bg-white p-3 sm:p-4 md:p-6">
                    <div className="flex flex-col gap-4">
                        <h2 className="text-base sm:text-lg font-medium">Buat Pengajuan Reimbursement</h2>
                ...
                <div className="flex flex-col gap-4 border border-black/10 bg-white p-3 sm:p-4 md:p-6">
                    <div className="flex flex-col gap-4">
                        <h2 className="text-base sm:text-lg font-medium">Attachment</h2>

                        <div className="flex flex-col w-full gap-2">
                            <label className="block text-sm font-medium text-black/60" htmlFor="file_input">Upload file</label>
                            <input className="block w-full text-sm text-black border border-black/10 px-3 sm:px-4 py-3 sm:py-4 cursor-pointer bg-[#f7f7f7] focus:outline-none focus:ring-2 focus:ring-[#43918B]/60" aria-describedby="file_input_help" id="file_input" type="file" accept=".jpg, .jpeg, .png, .gif, .pdf, .doc, .docx, .xls" />
